...
public class DroneFieldOfView : MonoBehaviour
{
    ...
    EdgeInfo FindEdge(ViewCastInfo minViewCast, ViewCastInfo maxViewCast)
    {
        ...
        for (int i = 0; i < edgeResolveIterations; i++)
        {
            ...
            ViewCastInfo newViewCast = ViewCast(angle);
            bool edgeDistThresholdExceeded = Mathf.Abs(minViewCast.dst - newViewCast.dst) > edgeDstThreshold;
    ...
    /// <summary>
    /// Takes the angle in degrees and converts it into directions according to the Unity system.
    /// </summary>
