...
public class ControlledDrawer : ControlledObject {
    ...
    private void    OnOpen()
    {
        ...
        {
            GrabbableAtDistance distGrab = coll.GetComponent<GrabbableAtDistance>();
            if (distGrab != null)
            {
                distGrab.InteractObjectHighlighter.enabled = true;
                distGrab.OutlineObjectCopyHighlighter.active = true;
    ...
    private void OnClose()
    {
        ...
        foreach( Collider coll in colliders )
        {
            ...
            if ( distGrab != null )
            {
                distGrab.InteractObjectHighlighter.enabled = false;
